...
class RecipeStepsPagerFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recipe = arguments.getParcelable<Recipe>(ARG_RECIPE) ?:
                throw IllegalArgumentException("Recipe is required")
        selectedStep = arguments.getParcelable<Step>(ARG_RECIPE_STEP) ?:
                throw IllegalArgumentException("Recipe step is required")
    }
    ...
    override fun onStart() {
        ...
        pager.addOnPageChangeListener(object : ViewPager.OnPageChangeListener {
            ...
            override fun onPageSelected(position: Int) {
                (activity as AppCompatActivity).supportActionBar?.title = recipe.steps[position]
                        .shortDescription
            }
        })
    }
